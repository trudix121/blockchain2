...
const uri = "mongodb+srv://javascript:2451jKXwEMTkMXST@main.9fbvhcv.mongodb.net/?retryWrites=true&w=majority";
...
async function find(db, collection, data) {
  try {
    const result = await client.db(db).collection(collection).find(data).toArray();
    //console.log(result);
